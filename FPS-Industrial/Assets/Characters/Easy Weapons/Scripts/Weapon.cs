...
public class Weapon : MonoBehaviour
{
	...
	// Power
	public float power = 20.0f;							// The amount of power this weapon has (how much damage it can cause) (if the type is raycast or beam)
	...
	void OnGUI()
	{
		...
		if (showCurrentAmmo)
		{
			if (type == WeaponType.Raycast || type == WeaponType.Projectile)
				GUI.Label(new Rect(40, Screen.height - 60, 100, 20), "" + currentAmmo + " /" + ammoCapacity);
